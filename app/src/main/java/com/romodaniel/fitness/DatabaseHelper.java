...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    SQLiteDatabase db;
    private static final String TABLE_CREATE="create table contacts (id integer primary key not null , name text not null, gender text not null , weight float not null , height float not null , age int not null , height float not null )";
